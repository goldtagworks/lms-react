import { Alert, Badge, Box, Button, Card, Divider, Group, Stack, Title } from '@mantine/core';
...
export default function EnrollPage() {
    ...
    if (notFound || !course) {
        return (
            <AuthLayout hero={<PaymentHero variant="enroll" />}>
                <EmptyState
    ...
    return (
        <AuthLayout hero={<PaymentHero variant="enroll" />}>
            <Card withBorder aria-label={t('a11y.enrollActions', {}, '수강 액션')} component="aside" mb="lg" p={{ base: 'lg', md: 'xl' }} radius="lg" shadow="sm">
                <Stack gap="sm">
                    <Box>
